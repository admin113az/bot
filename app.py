...
# Hàm khởi tạo bot và thêm handler
def main() -> None:
...
from telegram.ext import Dispatcher, MessageHandler, filters, CallbackContext, ApplicationBuilder
...
def webhook():
    update = Update.de_json(request.get_json(force=True), Bot(TELEGRAM_BOT_TOKEN))
...
>>>>>>> 79f685a3e913b08bd9afd2914d1e2e2646388329
